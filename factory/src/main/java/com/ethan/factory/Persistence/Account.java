package com.ethan.factory.Persistence;
...
import com.ethan.factory.model.db.User_Table;
...
public class Account {
    ...
    public static void login(AccountRspModel model){
        // 储存当前的账户，token， 用户id，方便从数据库中查询我的信息
    ...
    public static User getUser(){
        // if null, return a new user
        // otherwise, select from the db
